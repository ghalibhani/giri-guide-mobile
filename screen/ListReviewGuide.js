...
export default function ListReviewGuide() {
  const reviews = [
    {
      id: "1",
  ...
  return (
    <ScrollView className='flex-1' style={{ backgroundColor: "#f8f8f8" }}>
      <View>
        ...
        <TouchableOpacity className='bg-ivory w-[30] h-[30] border border-soil absolute top-5 left-6 z-10 items-center justify-center rounded-full'>
