    ...
    <View className="bg-soil flex-1">
      ...
      <View className="flex-row gap-9 mt-8 mb-6 mx-6 justify-around px-5">
        <View className="gap-3 max-w-32 items-center">
          ...
          <View className={`w-[45px] align-middle justify-center border-2 ${currentStage === 1 ? 'border-daisy bg-daisy' : 'bg-ivory border-ivory'} px-4 py-2 rounded-full`}>
            <Text className="font-isemibold text-lg ml-[1] text-soil">1</Text>
          </View>

          <View className="flex-col align-middle justify-center">
            <Text className={`font-iregular text-center text-xs ${currentStage === 1 ? 'text-daisy': 'text-ivory'}`}>Daftar</Text>
            <Text className={`font-iregular text-center text-xs ${currentStage === 1 ? 'text-daisy': 'text-ivory'}`}>Pendaki</Text>
          </View>
        </View>

        <View className="gap-3 max-w-32 items-center">
          <View className={`w-[45px] align-middle justify-center border-2 ${currentStage === 2 ? 'border-daisy bg-daisy' : 'bg-ivory border-ivory'} px-4 py-2 rounded-full`}>
            <Text className="font-isemibold text-lg ml-[1] text-soil">2</Text>
          </View>

          <View className="flex-col align-middle justify-center">
            <Text className={`font-iregular text-center text-xs ${currentStage === 2 ? 'text-daisy': 'text-ivory'}`}>Porter</Text>
          </View>
        </View>

        <View className="gap-3 max-w-32 items-center">
          <View className={`w-[45px] align-middle justify-center border-2 ${currentStage === 3 ? 'border-daisy bg-daisy' : 'bg-ivory border-ivory'} px-4 py-2 rounded-full`}>
            <Text className="font-isemibold text-lg ml-[1] text-soil">3</Text>
          </View>

          <View className="flex-col align-middle justify-center">
            <Text className={`font-iregular text-center text-xs ${currentStage === 3 ? 'text-daisy': 'text-ivory'}`}>Review</Text>
          </View>
        </View>
