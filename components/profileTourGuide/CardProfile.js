        ...
        <View className="gap-5">
            <View className="bg-evergreen rounded-verylarge px-6 pt-8 pb-custom">
                ...
                <View className="items-center gap-4">
                    ...
                    <Text className=" mt-4 font-ibold text-lg text-ivory">Nama Tour Guide</Text>
                </View>
            ...
            <View className="bg-white rounded-xl mx-6 px-5 py-5 -mt-32 z-0">
                <View className="flex-col justify-around gap-4">
                    <View className="items-center gap-[5]">
                        ...
                        <Text className="text-xs font-iregular text-thistle">Banyak pendakian yang selesai</Text>
                    </View>
                    ...
                    <View className="flex-row">
                        <View className="items-center gap-[5] w-1/2">
                            ...
                            <Text className="text-xs font-iregular text-thistle">Persentase selesai</Text>
                        </View>
                        ...
                        <View className="items-center gap-[5] w-1/2">
                            ...
                            <Text className="text-xs font-iregular text-thistle">Persentase menolak</Text>
                        </View>
                    </View>
